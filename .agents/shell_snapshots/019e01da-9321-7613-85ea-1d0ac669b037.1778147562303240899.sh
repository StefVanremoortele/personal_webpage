...
export NVM_DIR=/home/SimitStef/.nvm
export NVM_RC_VERSION=''
export PAGER=less
...
export TMUX=/tmp/tmux-1000/default,1085,0
export TMUX_PANE=%2
...
export WSL_INTEROP=/run/WSL/888_interop
export WT_PROFILE_ID='{61c54bbd-c2c6-5271-96e7-009a87ff44bf}'
export WT_SESSION=5a68f0ec-532c-4791-a7ad-54bfaa4e3641
